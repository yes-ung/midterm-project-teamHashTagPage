...
<div class="page mt3">
    <form id="addForm" name="addForm" method="post">
		...
		<input type="hidden" name="csrf" value="${sessionScope.CSRF_TOKEN}">
 		<input type="hidden" name="boardCommentId" value="<c:out value='${boardCommentVO.boardCommentId}' />">      
        <div class="mb3">
            ...
            <input 
                   ...
                   id="postId"
            	   name="postId"
            	   value="<c:out value='${boardCommentVO.postId}' />"
                   placeholder="postId" />
        </div>        <div class="mb3">
            ...
            <input 
            	   ...
            	   value="<c:out value='${boardCommentVO.boardCommentContent}' />"
...
<%--         <div class="mb3">
            ...
            <input 
            	   ...
            	   value="<c:out value='${boardCommentVO.boardCommentCreatedAt}' />"
        ...
        <div class="mb3">
            ...
            <input 
            	   ...
            	   value="<c:out value='${boardCommentVO.boardCommentIsDeleted}' />"
            ...
            <input 
                   ...
                   id="userId"
            	   name="userId"
            	   value="<c:out value='${boardCommentVO.userId}' />"
                   placeholder="userId" />
        </div>
        <div class="mb3">
...
<script type="text/javascript">
	function fn_save() {
		...
		$("#addForm").attr("action",'<c:out value="/boardComment/edit.do"/>')
		.submit();		
	}
	/* 삭제: /dept/delete.do */
	function fn_delete() {
		$("#addForm").attr("action",'<c:out value="/boardComment/delete.do"/>')
		.submit();
	}
</script>
